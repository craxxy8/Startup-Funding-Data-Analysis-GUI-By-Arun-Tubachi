...
main = tk.Tk()
main.title("Startup Funding Analysis by Arun Tubachi")
main.geometry("1300x1200")

font = ('times', 16, 'bold')
title = Label(main, text='Startup Funding Data Analysis GUI By Arun Tubachi')
title.config(bg='black', fg='dodger blue')
...
uploadButton = Button(main, text="UPLOAD YOUR DATASET", command=uploadDataset)
...
cleanDataButton = Button(main, text="CLEAN YOUR DATA", command=runcleandata)
cleanDataButton.place(x=50, y=350)
cleanDataButton.config(font=font1)

analyseButton = Button(main, text="ANALYSE DATA", command=Dataanalyse)
analyseButton.place(x=50, y=450)
analyseButton.config(font=font1)

visualizeButton = Button(main, text="VISUALIZE DATA", command=visualizeinsights)
